...
export const list = () => query('SELECT name, email, characters, created_at FROM story ORDER BY created_at DESC')
    .then(stories => stories.map(story => ({...story, characters: story.characters.split(';')})))
